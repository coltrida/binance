...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function _call($method, $params, $type = 'GET')
        {
                        /** @var \KriosMane\CoinMarketCap\Api $instance */
                        return $instance->_call($method, $params, $type);
        }
                    /**
         ...
         * @static 
         */ 
        public static function all_cryptos($params = [])
        {
                        /** @var \KriosMane\CoinMarketCap\Api $instance */
                        return $instance->all_cryptos($params);
        }
     ...
     */ 
         ...
         * @static 
         */ 
        public static function setAPI($key, $secret)
        {
                        /** @var \sabramooz\binance\BinanceAPI $instance */
                        return $instance->setAPI($key, $secret);
        }
                    /**
         * Get ticker
         *
         ...
         * @static 
         */ 
        public static function getTicker($symbol)
        {
                        /** @var \sabramooz\binance\BinanceAPI $instance */
         ...
         * @static 
         */ 
        public static function getAvgPrice($symbol)
        {
                        /** @var \sabramooz\binance\BinanceAPI $instance */
                        return $instance->getAvgPrice($symbol);
        }
                    /**
         * 
         *
         ...
         * @static 
         */ 
        public static function getRecentTrades($symbol = 'BNBBTC', $limit = 500)
        {
                        /** @var \sabramooz\binance\BinanceAPI $instance */
         ...
         * @static 
         */ 
        public static function getAllOrders($symbol)
        {
                        /** @var \sabramooz\binance\BinanceAPI $instance */
                        return $instance->getAllOrders($symbol);
        }
                    /**
         ...
         * @static 
         */ 
        public static function marketSell($symbol, $quantity)
        {
                        /** @var \sabramooz\binance\BinanceAPI $instance */
                        return $instance->marketSell($symbol, $quantity);
        }
                    /**
         * Base trade function
         *
         ...
         * @static 
         */ 
        public static function trade($symbol, $quantity, $side, $type = 'MARKET', $price = false)
        {
                        /** @var \sabramooz\binance\BinanceAPI $instance */
                        return $instance->trade($symbol, $quantity, $side, $type, $price);
        }
                    /**
         * Buy at market price
         *
         ...
         * @static 
         */ 
        public static function marketBuy($symbol, $quantity)
        {
                        /** @var \sabramooz\binance\BinanceAPI $instance */
                        return $instance->marketBuy($symbol, $quantity);
        }
                    /**
         * Sell limit
         *
         ...
         * @static 
         */ 
        public static function limitSell($symbol, $quantity, $price)
        {
                        /** @var \sabramooz\binance\BinanceAPI $instance */
                        return $instance->limitSell($symbol, $quantity, $price);
        }
                    /**
         * Buy limit
         *
         ...
         * @static 
         */ 
        public static function limitBuy($symbol, $quantity, $price)
        {
                        /** @var \sabramooz\binance\BinanceAPI $instance */
                        return $instance->limitBuy($symbol, $quantity, $price);
        }
                    /**
         * Deposit Address
         *
         ...
         * @static 
         */ 
        public static function depositAddress($symbol)
        {
                        /** @var \sabramooz\binance\BinanceAPI $instance */
                        return $instance->depositAddress($symbol);
        }
...
namespace  { 
            ...
            class CoinMarketCapApi extends \KriosMane\CoinMarketCap\Facades\CoinMarketCap {}
            class Flare extends \Facade\Ignition\Facades\Flare {}
            class Binance extends \sabramooz\binance\BinanceAPIFacade {}
